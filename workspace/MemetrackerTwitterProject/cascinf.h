...
public:
  ...
  void SaveInferredDynamicGephi(const TStr& OutFNm, const TFltV& Steps, const bool& lwcc=false, const int& NodesOn=0, const int& SpainOn=0, const TIntV& NIdV=TIntV());
