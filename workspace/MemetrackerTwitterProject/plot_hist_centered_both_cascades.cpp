...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		// Plotting
		Tools::plotTwoHistShift(quotes1,twitter1,3600,"hours","Memes-Twitter-urls-MEDIAN-Volumes", MEDIAN, "Memes", "contents on Twitter");
		Tools::plotTwoHistShift(quotes1,twitter1,3600,"hours","Memes-Twitter-urls-MAX-Volumes", MAX, "Memes", "urls on Twitter");
		Tools::plotTwoHistShift(quotes2,twitter2,3600,"hours","Memes-Twitter-contents-MEDIAN-Volumes", MEDIAN, "Memes", "contents on Twitter");
		Tools::plotTwoHistShift(quotes2,twitter2,3600,"hours","Memes-Twitter-contents-MAX-Volumes", MAX, "Memes", "urls on Twitter");
