...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		// URLS
		THash< TStr , CascadeElementV > quotes1 = loadQuotes("DATA/QuotesPreprocessedData_NIFTY_RANGEFIXED_FINALFILTERED_HAVINGBOTH.rar");
		THash< TUInt , TSecTmV > twitter1 = loadTwitter("DATA/CascadesFullUrlsOnTwitterData_FINALFILTERED_HAVINGBOTH.rar");

		// CONTENTS
		THash< TStr , CascadeElementV > quotes2 = loadQuotes("DATA/QuotesPreprocessedData_NIFTY_RANGEFIXED_FINALFILTERED_HAVINGBOTH.rar");
		THash< TUInt , TSecTmV > twitter2 = loadTwitter("DATA/CascadesOnTwitterData_FINALFILTERED_HAVINGBOTH.rar");
